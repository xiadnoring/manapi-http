...
#else
#   define MANAPIHTTP_LOG(...) manapi::debug::log_ (__LINE__, __FILE_NAME__, __func__, manapi::ERR_OK, __VA_ARGS__)
#   define MANAPIHTTP_LOG2(...) manapi::debug::log_ (__LINE__, __FILE_NAME__, __func__, manapi::ERR_OK, __VA_ARGS__);
#   define RETHROW_MANAPIHTTP_EXCEPTION(errnum, ...) manapi::debug::error_ (__LINE__, __FILE_NAME__, __func__, errnum, __VA_ARGS__)
#   define RETHROW_MANAPIHTTP_EXCEPTION2(errnum, ...) manapi::debug::error_ (__LINE__, __FILE_NAME__, __func__, errnum, __VA_ARGS__)
#endif
