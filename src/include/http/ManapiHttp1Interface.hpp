...
namespace manapi::net::worker {
    ...
    manapi::error::status default_wrk_http_all_global_init (wrk_interface_global_t *global, worker::interface_worker *w) MANAPIHTTP_NOEXPECT;
    ...
    manapi::error::status default_wrk_http1_global_init (manapi::net::worker::wrk_interface_global_t *global, manapi::net::worker::interface_worker *w) MANAPIHTTP_NOEXPECT;
}
