...
manapi::json_error::status::status(err_num code, std::string_view msg, std::string data, std::size_t pos, std::string path) : error::status(code, msg) {
    this->pos_ = pos;
...
manapi::json_error::status::status() : error::status() {
    this->pos_ = 0;
}
