...
// }
//
// void manapi::net::worker::http_v2::close_connection(std::shared_ptr<worker::connection> conn, bool clean_disconnect) {
//     /* nothing to do */
// }
//
...
//         if (copy) {
//             auto rhs = this->worker->sync_write(this->connection.get(), this->write_buffer->buffer->data() + this->write_buffer_current,
//                 this->write_buffer_size ? this->write_buffer_size : copy, this->write_buffer_last == this->write_buffer.get());
//             if (rhs < 0) {
//                 if (rhs == IO_WANT_AGAIN) {
//
//                 }
