...
manapi::net::worker::http_v2::http_v2(net::http::site site, bufferpool_t bufferpool, std::shared_ptr<worker::worker_config_t> worker_data) : base(std::move(site), std::move(bufferpool), std::move(worker_data)) {}
