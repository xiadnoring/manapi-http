...
namespace manapi {
    ...
    protected:
        ...
        static void _erase_task (const std::shared_ptr<data_t> &data_,const size_t &id);

        static storage::iterator _erase_task (const std::shared_ptr<data_t> &data_,storage::iterator task);

        static sorted_storage::iterator _erase_task (const std::shared_ptr<data_t> &data_,sorted_storage::iterator sorted_task);
        ...
        static void _update_interval_state (const std::shared_ptr<data_t> &data_, const size_t& id);
