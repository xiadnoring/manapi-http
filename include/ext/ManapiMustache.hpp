...
#define MANAPI_KAINJOW_MUSTACHE_VERSION_MAJOR 5
#define MANAPI_KAINJOW_MUSTACHE_VERSION_MINOR 0
#define MANAPI_KAINJOW_MUSTACHE_VERSION_PATCH 0



namespace manapi::kainjow::mustache {
