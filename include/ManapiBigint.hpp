...
namespace manapi {
    ...
    public:
        ...
        explicit bigint(const std::string &num, const unsigned long int &precision = 128);
        explicit bigint(const std::wstring &num, const unsigned long int &precision = 128);
        // explicit    bigint(const long long int &num,           const size_t &precision = 128);
        explicit bigint(const ssize_t &num, const unsigned long int &precision = 128);
        explicit bigint(const int &num, const unsigned long int &precision = 128);
        explicit bigint(const double &num, const unsigned long int &precision = 128);
        explicit bigint(const long double &num, const unsigned long int &precision = 128);
        // explicit    bigint(const unsigned long &num, const unsigned long int &precision = 128);
        explicit bigint(const mpf_t &num, const unsigned long int &precision = 128);
