...
namespace manapi::net::worker {
    ...
    public:
        WolfSSL_TLS (std::shared_ptr<net::worker::site> site, std::shared_ptr<multithread_storage::worker_t> wdata, manapi::net::http::config *config);

        ~WolfSSL_TLS () override;

        manapi::future<manapi::status> init(std::size_t deep) override;

        static std::shared_ptr<worker::WolfSSL_TLS> create (std::shared_ptr<net::worker::site> site, std::shared_ptr<multithread_storage::worker_t> wdata, manapi::net::http::config* config);
