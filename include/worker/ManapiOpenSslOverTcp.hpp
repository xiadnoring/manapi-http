...
namespace manapi::net::worker {
    ...
    public:
        OpenSSL_TLS (std::shared_ptr<net::worker::site> site, std::shared_ptr<multithread_storage::worker_t> wdata, manapi::net::http::config *config);

        ~OpenSSL_TLS ();

        static std::shared_ptr<worker::OpenSSL_TLS> create (std::shared_ptr<net::worker::site> site, std::shared_ptr<multithread_storage::worker_t> wdata, manapi::net::http::config *config);
