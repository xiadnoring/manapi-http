...
namespace manapi::compress {
    future<bool> deflate_compress_file(const std::shared_ptr<manapi::async::context> &ctx, const std::string &src, const std::string &dest, const int &level = Z_DEFAULT_COMPRESSION, const int &strategy = Z_DEFAULT_STRATEGY);
    ...
    future<bool> gzip_compress_file(const std::shared_ptr<manapi::async::context> &ctx, const std::string &src, const std::string &dest, const int &level = Z_DEFAULT_COMPRESSION, const int &strategy = Z_DEFAULT_STRATEGY);
