...
namespace manapi::crypto {
     ...
     */
    DLLExportImport manapi::error::status_or<std::string> aes_encrypt (std::string_view data, std::string_view key, std::string_view iv, ciphers algorithm = ciphers::AES_128_CBC);
     ...
     */
    DLLExportImport manapi::error::status_or<std::string> aes_decrypt (std::string_view data, std::string_view key, std::string_view iv, ciphers algorithm = ciphers::AES_128_CBC);
}