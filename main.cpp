...
int main () {
    manapi::json json (R"("FsdfgSosDiG\t\tj9345[-sd=f-,/.\n")", true);
    std::cout << json.as_string() << "\n";
}
...
//             std::cout << static_cast<std::string *> (resp.get_custom_data().src)->data() << "\n";
...
//             resp.set_custom_data({new std::string("hello world"), [] (void *x) -> void {
