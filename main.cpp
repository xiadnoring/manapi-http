...
int main (int argc, char *argv[]) {
    ...
    ctx->logger()->callback(
        [mx = std::move(mx)](manapi::logger_type type, std::string_view service, int error_code, std::string msg) -> void {
    ...
    ctx->run(ctx, loops, [server_ctx] (const std::function<void()> &bind) -> void {
